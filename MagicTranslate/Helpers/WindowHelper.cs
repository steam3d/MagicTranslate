...
namespace MagicTranslate.Helper
{
    ...
    {
        static public Window CreateWindow(Type sourceWindowType)
        {
            var instance = Activator.CreateInstance(sourceWindowType);
            if (instance is Window newWindow)
            {
